...
import AddTagBlock from 'components/TagsBlock/AddTagBlock';
...
const Sidebar: FC<ISidebar> = ({ width }) => {
    ...
    const { changeSelectedTag, removeSelectedTag } = useActions();
    ...
    return (
        <Grid container direction="column" className="sidebar" sx={{ width: 200 }}>
            <Grid
                ...
                <CustomButton className="sidebar__tag-button" onClick={() => onClick()}>
                    <Grid
                        container
